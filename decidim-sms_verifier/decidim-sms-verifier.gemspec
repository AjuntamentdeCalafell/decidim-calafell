...
require "decidim/sms_verifier/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name = "decidim-sms_verifier"
  s.version = Decidim::SmsVerifier::VERSION
  ...
  DECIDIM_VERSION = "~> #{Decidim::SmsVerifier::DECIDIM_VERSION}"
